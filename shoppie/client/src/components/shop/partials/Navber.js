      ...
      <nav className="fixed top-0 w-full z-20 shadow-lg lg:shadow-none bg-white">
        <div className="m-4 md:mx-12 md:my-6 grid grid-cols-4 lg:grid-cols-3">
          <div className="hidden lg:block col-span-1 flex text-gray-600 mt-1">
            <span
              className="hover:bg-gray-200 px-4 py-3 rounded-lg font-light tracking-widest hover:text-black-800 cursor-pointer shop"
          ...
          <div className="flex items-right col-span-2 lg:col-span-1 flex justify-end">
            ...
            <div
              ...
              className="hover:bg-red-200 px-2 py-2 rounded-lg relative cursor-pointer"
              title="Cart"
            >
              <svg
              ...
              <span className="absolute top-0 ml-6 mt-1 cart-count rounded px-1 text-black text-xs hover:text-gray-200 font-semibold">
        ...
        >
          <div className="col-span-1 flex flex-col text-gray-600">
            <span
              className="shop font-medium text-lg tracking-widest hover:text-gray-800 hover:bg-gray-200 px-3 py-2 rounded-lg cursor-pointer"
              onClick={(e) => history.push("/")}
            >
              Shop
            </span>
