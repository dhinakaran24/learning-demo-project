  ...
  return (
    <Fragment>
      <div className="flex justify-between font-medium">
        ...
        >
          <span className="text-md md:text-lg headhov">
            Categories
          </span>
          <svg
            className="w-4 h-4 symbol"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
        ...
        <div className="flex space-x-2">
          ...
          >
            <span className="text-md md:text-lg headhov">Filter</span>
            <span>
              <svg
                className="w-4 h-4 text-gray-700 symbol"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
          ...
          >
            <span className="text-md md:text-lg headhov">Search</span>
            <span>
              <svg
                className="w-4 h-4 text-gray-700 symbol"
                fill="none"
